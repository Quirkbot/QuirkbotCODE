...
#yarn run gulp -- build:gzip --environment=development
...
#yarn run gulp -- build:gzip --environment=stage
#mkdir dist/stage
...
yarn run gulp -- build:gzip --environment=production
...
yarn run gulp -- build:gzip --environment=lite
mkdir dist/lite
